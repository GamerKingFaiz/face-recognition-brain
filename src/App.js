...
class App extends Component {
  ...
  onPictureSubmit = () => {
    ...
    fetch('https://faiz-face-recognition-brain.herokuapp.com/imageurl', { // Clarifai API call
				method: 'post',
	...
	.then(response => {
		if (response) {
			fetch('https://faiz-face-recognition-brain.herokuapp.com/image', { // Entries count is incremented by 1
				method: 'put',
				headers: {'Content-Type': 'application/json'},
				body:   JSON.stringify({
